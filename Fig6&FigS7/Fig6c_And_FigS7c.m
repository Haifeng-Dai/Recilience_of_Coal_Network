...
load('./Data/Data_Empirical_fw.mat', 'Data', 'MaxPer')
Reff = Data(:,:,3);
etaeff = Data(:,:,4);
R = Data(:,:,1);
ReffMean = mean(Reff);
...
saveas(Fig1, './Figure/Fig6c', 'epsc')
saveas(Fig1, './Figure/Fig6c')
saveas(Fig2, './Figure/FigS7c', 'epsc')
saveas(Fig2, './Figure/FigS7c')