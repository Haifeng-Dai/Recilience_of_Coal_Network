function Empirical_fl

clear; clc; rng('default'); rng(0); tic;

load('./Data/Data_Empirical.mat', 'C'); load('./Data/Data_Fig2a.mat', 'eta', 'x3')
 
N = size(C,1);
MaxPer = 0.8; loop = 5; x0h = ones(N,1) * 2;
...
[D1,D2,D3] = size(Data); t = toc; disp(t); save ./Data/Data_Empirical_fl