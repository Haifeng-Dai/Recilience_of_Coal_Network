...
p=0.1:0.1:0.9; loop = 50; S = 100; mu = 1; KL = 0.2;
...
Fig = figure('Name','R_eff vs connectivity','NumberTitle','off');
plot(p,eta_eff,'.','MarkerSize',20); hold on;
plot(p,eta_eff_c,'--','LineWidth',2,'Color','#D95319');
text(0.15,0.85,'Critical Value','FontSize',18,'FontName','Arial','Color','#D95319')
xlabel('Connectivity'); ylabel('\eta_{eff}'); xlim([0.1 0.9]);
set(gca,'FontSize',18,'FontName','Arial','XTick',[0.1,0.3,0.5,0.7,0.9]);

saveas(Fig,'./Figure/Fig2b','epsc'); saveas(Fig,'./Figure/Fig2b');