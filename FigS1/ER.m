...
p = 0.1:0.05:0.9; N = 100; mu = 1; KL = 0.2; x_axis = length(p); loop = 100;
alpha = 0.5; c = 0.2; K = 1; delta = 1/5; theta = 0.95;
Data = zeros(x_axis,loop,4);
x0h = ones(N,1) * 2;

parfor i = 1:x_axis
    Datatemp = zeros(loop, 4); Datemp1 = zeros(N,loop); Datemp2 = Datemp1;
    for j = 1:loop
...
[D1,D2,D3] = size(Data); t = toc; save('./Data/Data_ER')