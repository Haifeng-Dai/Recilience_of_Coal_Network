...
% Shannxi_fn_High; Shannxi_fn_Low; Shannxi_fn_Random; Shannxi_fl; Shannxi_fw; Shannxi_fw_low

load ./Data/Data_Shannxi_fw.mat; Reff1 = Data(:,:,3); etaeff1 = Data(:,:,4);
load ./Data/Data_Shannxi_fl.mat; Reff2 = Data(:,:,3); etaeff2 = Data(:,:,4);
load ./Data/Data_Shannxi_fn_High.mat; Reff3 = Data(:,:,3); etaeff3 = Data(:,:,4);
load ./Data/Data_Shannxi_fn_Low.mat; Reff4 = Data(:,:,3); etaeff4 = Data(:,:,4);
load ./Data/Data_Shannxi_fn_Random.mat; Reff5 = Data(:,:,3); etaeff5 = Data(:,:,4);
load ./Data/Data_Shannxi_fw_low.mat; Reff6 = Data(:,:,3); etaeff6 = Data(:,:,4);
...
saveas(Fig,'./Figure/FigS7c','epsc'); saveas(Fig,'./Figure/FigS7c');