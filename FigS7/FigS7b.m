...
load ./Data/Data_InnerMongolia_fw.mat; Reff1 = Data(:,:,3); etaeff1 = Data(:,:,4);
load ./Data/Data_InnerMongolia_fl.mat; Reff2 = Data(:,:,3); etaeff2 = Data(:,:,4);
load ./Data/Data_InnerMongolia_fn_High.mat; Reff3 = Data(:,:,3); etaeff3 = Data(:,:,4);
load ./Data/Data_InnerMongolia_fn_Low.mat; Reff4 = Data(:,:,3); etaeff4 = Data(:,:,4);
load ./Data/Data_InnerMongolia_fn_Random.mat; Reff5 = Data(:,:,3); etaeff5 = Data(:,:,4);
load ./Data/Data_InnerMongolia_fw_low.mat; Reff6 = Data(:,:,3); etaeff6 = Data(:,:,4);
...
saveas(Fig,'./Figure/FigS7b','epsc'); saveas(Fig,'./Figure/FigS7b');