function InnerMongolia_fw_low

clear; clc; rng('default'); rng(0); close all; tic; load('./Data/Data_Fig2a.mat', 'eta', 'x_high'); load('./Data/Data_Empirical.mat', 'C')
...
[D1,D2,D3] = size(Data); t = toc; save ./Data/Data_InnerMongolia_fw_low